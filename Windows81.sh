...
qemu-img create -f raw windows8.img 32G
...
wget -O windows8.iso 'https://dl.malwarewatch.org/windows/Windows%208.1.iso'
echo "Key Windows 8.1 : XKY4K-2NRWR-8F6P2-448RF-CRYQH"
...
sudo qemu-system-x86_64 \
  ...
  -drive file=windows8.img,format=raw,if=virtio \
